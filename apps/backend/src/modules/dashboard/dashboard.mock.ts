import { CoinPriceToken, AiInsightResponse, CryptoMemeResponse, CryptoNewsItem } from './dashboard.types';

// ─── Internal price map (used by service to build CoinPriceToken[]) ───────────

export const MOCK_PRICE_MAP = {
...
export const MOCK_COIN_PRICES: CoinPriceToken[] = Object.entries(MOCK_PRICE_MAP).map(
    ([symbol, data]) => ({
...
export const MOCK_NEWS: CryptoNewsItem[] = [
    {
        id: 'mock-1',
...
const MOCK_MEME_POOL: CryptoMemeResponse[] = [
    ...
    },
    {
        id: 'meme-2',
        imageUrl:
            'https://images.unsplash.com/photo-1622630998477-20aa696ecb05?q=80&w=500&auto=format&fit=crop',
        caption: 'Me explaining Crypto to my family during dinner',
    },
    {
        id: 'meme-3',
        imageUrl:
            'https://images.unsplash.com/photo-1640340434855-6084b1f4901c?q=80&w=500&auto=format&fit=crop',
        caption: 'Checking portfolio every 45 seconds expecting changes',
    },
];

/** Returns a deterministic daily meme from the pool */
export function getDailyMeme(): CryptoMemeResponse {
